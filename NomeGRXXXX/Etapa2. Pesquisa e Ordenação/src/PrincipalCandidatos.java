...
public class PrincipalCandidatos {
    ...
    public static void main(String[] args) {
        ...
        int tamanhoArray = aleatorio.nextInt(100) + 1; // array entre 1 e 100
    ...
    public static void ordenaCandidatosPorNome(Candidato[] candidatos) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            while (j >= 0 && candidatos[j].getNome().compareTo(copia.getNome()) > 0) {
                candidatos[j + 1] = candidatos[j]; // desloca o candidato anterior uma posição à direita
                j = j - 1; // atualiza o índice
            }
            candidatos[j + 1] = copia; // insere o candidato atual na posição correta
        }
    }
